        ...
        <nav className="hidden md:flex justify-center space-x-6 lg:space-x-8 lg:w-2/4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem asChild>
                <SafeLink href="/products/subcategory/acides-amines" isPrimaryNav={true} className="font-medium">Acides aminés</SafeLink>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <SafeLink href="/products/subcategory/performance" isPrimaryNav={true} className="font-medium">Performance</SafeLink>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
